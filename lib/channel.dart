...
class ScryptedMedApiChannel extends ApplicationChannel {
  ...
  Future prepare() async {
    ...
    final config = ScryptedMedApiConfiguration(options.configurationFilePath);
...
class ScryptedMedApiConfiguration extends Configuration {
  ScryptedMedApiConfiguration(String fileName) : super.fromFile(File(fileName));
